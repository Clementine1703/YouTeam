...
from .schemas import PermissionCreate, PermissionInfo, PermissionUpdate
...
class PermissionService:
    ...
    async def get_permission_filter(self, permission_filter: PermissionFilter, sortBy: str, sortDesc: bool) -> list[PermissionInfo]:
    ...
    async def update_permission(self, permission_id: int, data_for_update: PermissionUpdate) -> Permission:
